...
<head>
    ...
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/combined_css_entry_page_libraries.css'.$cache_timestamp; ?>" rel="stylesheet">
    ...
    <script src="<?php echo Registry::load('config')->site_url.'assets/js/combined_js_entry_page_libraries.js'.$cache_timestamp; ?>"></script>
