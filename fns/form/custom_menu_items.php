...
if (role(['permissions' => ['custom_menu' => ['create', 'edit']], 'condition' => 'OR'])) {
    ...
    if (isset($load["menu_item_id"]) && role(['permissions' => ['custom_menu' => 'edit']])) {
        ...
        $columns = [
            ...
            'custom_menu_items.menu_item_order', 'custom_menu_items.disabled', 'custom_menu_items.menu_item_visibility','custom_menu_items.show_on_chat_page_top'
        ];
    ...
    $form['fields']->show_on_chat_page_top = [
        "title" => Registry::load('strings')->show_on_chat_page.' ['.Registry::load('strings')->top.']',
        "tag" => 'select', "class" => 'field'
    ];
    $form['fields']->show_on_chat_page_top['options'] = [
        "yes" => Registry::load('strings')->yes,
        "no" => Registry::load('strings')->no,
    ];

    $form['fields']->show_on_chat_page = [
        "title" => Registry::load('strings')->show_on_chat_page.' ['.Registry::load('strings')->bottom.']',
        "tag" => 'select', "class" => 'field'
    ];
    ...
    if (isset($load["menu_item_id"]) && role(['permissions' => ['custom_menu' => 'edit']])) {
        ...
        $disabled = $show_on_landing_page_footer = $show_on_chat_page_top = $show_on_landing_page_header = 'no';
        ...
        if ((int)$menu_item['show_on_chat_page_top'] === 1) {
            $show_on_chat_page_top = 'yes';
        }
        ...
        $form['fields']->show_on_chat_page_top["value"] = $show_on_chat_page_top;
